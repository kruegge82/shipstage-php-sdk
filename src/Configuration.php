...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://dashboard.shipstage.com';
    ...
    {
        $report  = 'PHP SDK (kruegge82\shipstage) Debug Report:' . PHP_EOL;
    ...
    */
    public static function getHostString(array $hostSettings, int $hostIndex, array|null $variables = null): string
    {
        if (null === $variables) {
            $variables = [];
        }
