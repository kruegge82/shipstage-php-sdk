...
use kruegge82\shipstage\Model\ModelInterface;
...
class ObjectSerializer
{
     ...
     */
    public static function deserialize(mixed $data, string $class, array|null $httpHeaders = null): mixed
    {
        if (null === $data) {
            return null;
        }
        ...
        if (is_subclass_of($class, '\BackedEnum')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\kruegge82\shipstage\Model\\' . $data->{$discriminator};
