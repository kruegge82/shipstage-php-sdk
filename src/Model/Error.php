...
class Error implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'result' => 'string',
        'detail' => '\kruegge82\shipstage\Model\Detail'
    ];
    ...
    */
     ...
     * Gets detail
     *
     * @return \kruegge82\shipstage\Model\Detail
     */
    public function getDetail(): \kruegge82\shipstage\Model\Detail
    {
     ...
     * Sets detail
     *
     * @param \kruegge82\shipstage\Model\Detail $detail detail
     *
     * @return $this
     */
    public function setDetail(\kruegge82\shipstage\Model\Detail $detail): static
    {
        if (is_null($detail)) {
