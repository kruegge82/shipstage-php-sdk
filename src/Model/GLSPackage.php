 ...
 */
class GLSPackage implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GLSPackage';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (($this->container['weight'] > 40)) {
            $invalidProperties[] = "invalid value for 'weight', must be smaller than or equal to 40.";
        }
        ...
        if (($this->container['width'] > 80)) {
            $invalidProperties[] = "invalid value for 'width', must be smaller than or equal to 80.";
        }
        ...
        if (!is_null($this->container['free_reference']) && (mb_strlen($this->container['free_reference']) > 50)) {
            $invalidProperties[] = "invalid value for 'free_reference', the character length must be smaller than or equal to 50.";
        }
    ...
    public function setWeight(float $weight): static
    {
        ...
        if (($weight > 40)) {
            throw new InvalidArgumentException('invalid value for $weight when calling GLSPackage., must be smaller than or equal to 40.');
        }
        if (($weight < 1)) {
            throw new InvalidArgumentException('invalid value for $weight when calling GLSPackage., must be bigger than or equal to 1.');
        }
    ...
    public function setNumber(?int $number): static
    {
        ...
        if (($number < 1)) {
            throw new InvalidArgumentException('invalid value for $number when calling GLSPackage., must be bigger than or equal to 1.');
        }
    ...
    public function setLength(int $length): static
    {
        ...
        if (($length > 200)) {
            throw new InvalidArgumentException('invalid value for $length when calling GLSPackage., must be smaller than or equal to 200.');
        }
        if (($length < 1)) {
            throw new InvalidArgumentException('invalid value for $length when calling GLSPackage., must be bigger than or equal to 1.');
        }
    ...
    public function setWidth(int $width): static
    {
        ...
        if (($width > 80)) {
            throw new InvalidArgumentException('invalid value for $width when calling GLSPackage., must be smaller than or equal to 80.');
        }
        if (($width < 1)) {
            throw new InvalidArgumentException('invalid value for $width when calling GLSPackage., must be bigger than or equal to 1.');
        }
    ...
    public function setHeight(int $height): static
    {
        ...
        if (($height > 60)) {
            throw new InvalidArgumentException('invalid value for $height when calling GLSPackage., must be smaller than or equal to 60.');
        }
        if (($height < 1)) {
            throw new InvalidArgumentException('invalid value for $height when calling GLSPackage., must be bigger than or equal to 1.');
        }
    ...
    public function setFreeReference(?string $free_reference): static
    {
        ...
        if ((mb_strlen($free_reference) > 50)) {
            throw new InvalidArgumentException('invalid length for $free_reference when calling GLSPackage., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($free_reference) < 1)) {
            throw new InvalidArgumentException('invalid length for $free_reference when calling GLSPackage., must be bigger than or equal to 1.');
        }
