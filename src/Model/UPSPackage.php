 ...
 */
class UPSPackage implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'UPSPackage';
    ...
    protected static array $openAPITypes = [
        'required_items' => 'bool',
        'items' => '\kruegge82\shipstage\Model\UPSItem[]',
        'weight' => 'float',
        'number' => 'int',
        'length' => 'int',
        'width' => 'int',
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (($this->container['weight'] > 70)) {
            $invalidProperties[] = "invalid value for 'weight', must be smaller than or equal to 70.";
        }
        ...
        if (($this->container['length'] > 400)) {
            $invalidProperties[] = "invalid value for 'length', must be smaller than or equal to 400.";
        }
        ...
        if (($this->container['width'] > 400)) {
            $invalidProperties[] = "invalid value for 'width', must be smaller than or equal to 400.";
        }
        ...
        if (($this->container['height'] > 400)) {
            $invalidProperties[] = "invalid value for 'height', must be smaller than or equal to 400.";
        }
     ...
     * Gets items
     *
     * @return \kruegge82\shipstage\Model\UPSItem[]|null
     */
     ...
     * Sets items
     *
     * @param \kruegge82\shipstage\Model\UPSItem[]|null $items items
     *
     * @return $this
     */
    ...
    public function setWeight(float $weight): static
    {
        ...
        if (($weight > 70)) {
            throw new InvalidArgumentException('invalid value for $weight when calling UPSPackage., must be smaller than or equal to 70.');
        }
        if (($weight < 1)) {
            throw new InvalidArgumentException('invalid value for $weight when calling UPSPackage., must be bigger than or equal to 1.');
        }
    ...
    public function setNumber(?int $number): static
    {
        ...
        if (($number < 1)) {
            throw new InvalidArgumentException('invalid value for $number when calling UPSPackage., must be bigger than or equal to 1.');
        }
    ...
    public function setLength(int $length): static
    {
        ...
        if (($length > 400)) {
            throw new InvalidArgumentException('invalid value for $length when calling UPSPackage., must be smaller than or equal to 400.');
        }
        if (($length < 1)) {
            throw new InvalidArgumentException('invalid value for $length when calling UPSPackage., must be bigger than or equal to 1.');
        }
    ...
    public function setWidth(int $width): static
    {
        ...
        if (($width > 400)) {
            throw new InvalidArgumentException('invalid value for $width when calling UPSPackage., must be smaller than or equal to 400.');
        }
        if (($width < 1)) {
            throw new InvalidArgumentException('invalid value for $width when calling UPSPackage., must be bigger than or equal to 1.');
        }
    ...
    public function setHeight(int $height): static
    {
        ...
        if (($height > 400)) {
            throw new InvalidArgumentException('invalid value for $height when calling UPSPackage., must be smaller than or equal to 400.');
        }
        if (($height < 1)) {
            throw new InvalidArgumentException('invalid value for $height when calling UPSPackage., must be bigger than or equal to 1.');
        }
    ...
    public function setFreeReference(?string $free_reference): static
    {
        ...
        if ((mb_strlen($free_reference) > 35)) {
            throw new InvalidArgumentException('invalid length for $free_reference when calling UPSPackage., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($free_reference) < 1)) {
            throw new InvalidArgumentException('invalid length for $free_reference when calling UPSPackage., must be bigger than or equal to 1.');
        }
