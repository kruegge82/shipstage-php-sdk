...
/**
 * TNTDataModel Class Doc Comment
 *
 * @package  kruegge82\shipstage
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TNTDataModel implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TNTDataModel';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['from_phone']) && (mb_strlen($this->container['from_phone']) > 30)) {
    ...
    public function setFromCountry(string $from_country): static
    {
        ...
        if ((mb_strlen($from_country) > 2)) {
            throw new InvalidArgumentException('invalid length for $from_country when calling TNTDataModel., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($from_country) < 2)) {
            throw new InvalidArgumentException('invalid length for $from_country when calling TNTDataModel., must be bigger than or equal to 2.');
        }
    ...
    public function setFromContactName(string $from_contact_name): static
    {
        ...
        if ((mb_strlen($from_contact_name) > 30)) {
            throw new InvalidArgumentException('invalid length for $from_contact_name when calling TNTDataModel., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($from_contact_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_contact_name when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromCompanyName(?string $from_company_name): static
    {
        ...
        if ((mb_strlen($from_company_name) > 40)) {
            throw new InvalidArgumentException('invalid length for $from_company_name when calling TNTDataModel., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($from_company_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_company_name when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromAddress(string $from_address): static
    {
        ...
        if ((mb_strlen($from_address) > 30)) {
            throw new InvalidArgumentException('invalid length for $from_address when calling TNTDataModel., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($from_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_address when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromAdditionalAddress(?string $from_additional_address): static
    {
        ...
        if ((mb_strlen($from_additional_address) > 30)) {
            throw new InvalidArgumentException('invalid length for $from_additional_address when calling TNTDataModel., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($from_additional_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_additional_address when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromPostalCode(string $from_postal_code): static
    {
        ...
        if ((mb_strlen($from_postal_code) > 9)) {
            throw new InvalidArgumentException('invalid length for $from_postal_code when calling TNTDataModel., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($from_postal_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_postal_code when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromCity(string $from_city): static
    {
        ...
        if ((mb_strlen($from_city) > 40)) {
            throw new InvalidArgumentException('invalid length for $from_city when calling TNTDataModel., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($from_city) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_city when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromPhone(?string $from_phone): static
    {
        ...
        if ((mb_strlen($from_phone) > 30)) {
            throw new InvalidArgumentException('invalid length for $from_phone when calling TNTDataModel., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($from_phone) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_phone when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromEmail(?string $from_email): static
    {
        ...
        if ((mb_strlen($from_email) > 75)) {
            throw new InvalidArgumentException('invalid length for $from_email when calling TNTDataModel., must be smaller than or equal to 75.');
        }
        if ((mb_strlen($from_email) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_email when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToCountry(string $to_country): static
    {
        ...
        if ((mb_strlen($to_country) > 2)) {
            throw new InvalidArgumentException('invalid length for $to_country when calling TNTDataModel., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($to_country) < 2)) {
            throw new InvalidArgumentException('invalid length for $to_country when calling TNTDataModel., must be bigger than or equal to 2.');
        }
    ...
    public function setToContactName(string $to_contact_name): static
    {
        ...
        if ((mb_strlen($to_contact_name) > 30)) {
            throw new InvalidArgumentException('invalid length for $to_contact_name when calling TNTDataModel., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($to_contact_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_contact_name when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToCompanyName(?string $to_company_name): static
    {
        ...
        if ((mb_strlen($to_company_name) > 40)) {
            throw new InvalidArgumentException('invalid length for $to_company_name when calling TNTDataModel., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($to_company_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_company_name when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToAddress(string $to_address): static
    {
        ...
        if ((mb_strlen($to_address) > 30)) {
            throw new InvalidArgumentException('invalid length for $to_address when calling TNTDataModel., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($to_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_address when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToAdditionalAddress(?string $to_additional_address): static
    {
        ...
        if ((mb_strlen($to_additional_address) > 30)) {
            throw new InvalidArgumentException('invalid length for $to_additional_address when calling TNTDataModel., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($to_additional_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_additional_address when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToPostalCode(string $to_postal_code): static
    {
        ...
        if ((mb_strlen($to_postal_code) > 9)) {
            throw new InvalidArgumentException('invalid length for $to_postal_code when calling TNTDataModel., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($to_postal_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_postal_code when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToCity(string $to_city): static
    {
        ...
        if ((mb_strlen($to_city) > 40)) {
            throw new InvalidArgumentException('invalid length for $to_city when calling TNTDataModel., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($to_city) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_city when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToPhone(string $to_phone): static
    {
        ...
        if ((mb_strlen($to_phone) > 30)) {
            throw new InvalidArgumentException('invalid length for $to_phone when calling TNTDataModel., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($to_phone) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_phone when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToEmail(?string $to_email): static
    {
        ...
        if ((mb_strlen($to_email) > 75)) {
            throw new InvalidArgumentException('invalid length for $to_email when calling TNTDataModel., must be smaller than or equal to 75.');
        }
        if ((mb_strlen($to_email) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_email when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setInsuranceAmount(float $insurance_amount): static
    {
        ...
        if (($insurance_amount > 50000.0)) {
            throw new InvalidArgumentException('invalid value for $insurance_amount when calling TNTDataModel., must be smaller than or equal to 50000.0.');
        }
        if (($insurance_amount < 1.0)) {
            throw new InvalidArgumentException('invalid value for $insurance_amount when calling TNTDataModel., must be bigger than or equal to 1.0.');
        }
    ...
    public function setInsuranceContent(string $insurance_content): static
    {
        ...
        if ((mb_strlen($insurance_content) > 100)) {
            throw new InvalidArgumentException('invalid length for $insurance_content when calling TNTDataModel., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($insurance_content) < 1)) {
            throw new InvalidArgumentException('invalid length for $insurance_content when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setInvoiceNumber(?string $invoice_number): static
    {
        ...
        if ((mb_strlen($invoice_number) > 100)) {
            throw new InvalidArgumentException('invalid length for $invoice_number when calling TNTDataModel., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($invoice_number) < 1)) {
            throw new InvalidArgumentException('invalid length for $invoice_number when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setReference(?string $reference): static
    {
        ...
        if ((mb_strlen($reference) > 50)) {
            throw new InvalidArgumentException('invalid length for $reference when calling TNTDataModel., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($reference) < 1)) {
            throw new InvalidArgumentException('invalid length for $reference when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setSendungAvisieren(string $sendung_avisieren): static
    {
        ...
        if ((mb_strlen($sendung_avisieren) > 30)) {
            throw new InvalidArgumentException('invalid length for $sendung_avisieren when calling TNTDataModel., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($sendung_avisieren) < 1)) {
            throw new InvalidArgumentException('invalid length for $sendung_avisieren when calling TNTDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setStackable(string $stackable): static
    {
        ...
        if ((mb_strlen($stackable) > 3)) {
            throw new InvalidArgumentException('invalid length for $stackable when calling TNTDataModel., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($stackable) < 2)) {
            throw new InvalidArgumentException('invalid length for $stackable when calling TNTDataModel., must be bigger than or equal to 2.');
        }
    ...
    public function setUnNumber(?string $un_number): static
    {
        ...
        if ((mb_strlen($un_number) > 6)) {
            throw new InvalidArgumentException('invalid length for $un_number when calling TNTDataModel., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($un_number) < 6)) {
            throw new InvalidArgumentException('invalid length for $un_number when calling TNTDataModel., must be bigger than or equal to 6.');
        }
