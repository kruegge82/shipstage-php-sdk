...
class Data implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'packages' => '\kruegge82\shipstage\Model\TNTPackage[]',
        'from_country' => 'string',
        ...
        'bulky_goods' => 'bool',
        'premium' => 'bool',
        'check_age_service' => 'int',
        'endorsement' => '\kruegge82\shipstage\Model\Endorsement',
        'pickup_time' => '\kruegge82\shipstage\Model\PickupTime',
        'delivery_date' => 'string',
        'sendung_avisieren' => 'string',
        'hinweis1' => 'string',
        'hinweis2' => 'string',
        'amazon_buchungsdaten' => 'string',
        'stackable' => 'string',
        'dangerous_goods_type' => '\kruegge82\shipstage\Model\DangerousGoodType',
        'un_number' => 'string'
    ];
    ...
    protected static array $openAPIFormats = [
        ...
        'bulky_goods' => null,
        'premium' => null,
        'check_age_service' => null,
        'endorsement' => null,
        'pickup_time' => null,
        'delivery_date' => null,
        'sendung_avisieren' => null,
        'hinweis1' => null,
        'hinweis2' => null,
        'amazon_buchungsdaten' => null,
        'stackable' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'reference' => false,
        'outlet_routing' => false,
        'bulky_goods' => false,
        'premium' => false,
        'check_age_service' => false,
        'endorsement' => false,
        'pickup_time' => false,
        'delivery_date' => false,
        'sendung_avisieren' => false,
        'hinweis1' => false,
        'hinweis2' => false,
        'amazon_buchungsdaten' => false,
        'stackable' => false,
        'dangerous_goods_type' => false,
        'un_number' => false
    ];
    ...
    protected static array $attributeMap = [
        ...
        'reference' => 'reference',
        'outlet_routing' => 'outlet_routing',
        'bulky_goods' => 'bulky_goods',
        'premium' => 'premium',
        'check_age_service' => 'check_age_service',
        'endorsement' => 'endorsement',
        'pickup_time' => 'pickup_time',
        'delivery_date' => 'delivery_date',
        'sendung_avisieren' => 'sendung_avisieren',
        'hinweis1' => 'hinweis1',
        'hinweis2' => 'hinweis2',
        'amazon_buchungsdaten' => 'amazon_buchungsdaten',
        'stackable' => 'stackable',
        'dangerous_goods_type' => 'dangerous_goods_type',
        'un_number' => 'un_number'
    ];
    ...
    protected static array $setters = [
        ...
        'outlet_routing' => 'setOutletRouting',
        'bulky_goods' => 'setBulkyGoods',
        'premium' => 'setPremium',
        'check_age_service' => 'setCheckAgeService',
        'endorsement' => 'setEndorsement',
        'pickup_time' => 'setPickupTime',
        'delivery_date' => 'setDeliveryDate',
        'sendung_avisieren' => 'setSendungAvisieren',
        'hinweis1' => 'setHinweis1',
        'hinweis2' => 'setHinweis2',
        'amazon_buchungsdaten' => 'setAmazonBuchungsdaten',
        'stackable' => 'setStackable',
        'dangerous_goods_type' => 'setDangerousGoodsType',
    ...
    protected static array $getters = [
        ...
        'outlet_routing' => 'getOutletRouting',
        'bulky_goods' => 'getBulkyGoods',
        'premium' => 'getPremium',
        'check_age_service' => 'getCheckAgeService',
        'endorsement' => 'getEndorsement',
        'pickup_time' => 'getPickupTime',
        'delivery_date' => 'getDeliveryDate',
        'sendung_avisieren' => 'getSendungAvisieren',
        'hinweis1' => 'getHinweis1',
        'hinweis2' => 'getHinweis2',
        'amazon_buchungsdaten' => 'getAmazonBuchungsdaten',
        'stackable' => 'getStackable',
        'dangerous_goods_type' => 'getDangerousGoodsType',
    ...
    public const SERVICE_CODE_TNT_EXPRESS = 'tnt_express';
    public const SERVICE_CODE_TNT_EXPRESS9 = 'tnt_express9';
    public const SERVICE_CODE_TNT_EXPRESS10 = 'tnt_express10';
    public const SERVICE_CODE_TNT_EXPRESS12 = 'tnt_express12';
    public const SERVICE_CODE_TNT_ECONOMY = 'tnt_economy';
    public const SHIPMENT_TYPE_COMMERCIAL_GOODS = 'COMMERCIAL_GOODS';
    public const SHIPMENT_TYPE_DOCUMENT = 'DOCUMENT';
    public const SHIPMENT_TYPE_COMMERCIAL_SAMPLE = 'COMMERCIAL_SAMPLE';
    public const SHIPMENT_TYPE_RETURN_OF_GOODS = 'RETURN_OF_GOODS';
    public const SHIPMENT_TYPE_PRESENT = 'PRESENT';
    public const CHECK_AGE_SERVICE_NUMBER_16 = 16;
    public const CHECK_AGE_SERVICE_NUMBER_18 = 18;
    ...
    {
        return [
            self::SERVICE_CODE_TNT_EXPRESS,
            self::SERVICE_CODE_TNT_EXPRESS9,
            self::SERVICE_CODE_TNT_EXPRESS10,
            self::SERVICE_CODE_TNT_EXPRESS12,
            self::SERVICE_CODE_TNT_ECONOMY,
        ];
    }
    ...
    public function getShipmentTypeAllowableValues()
    {
        return [
            ...
            self::SHIPMENT_TYPE_RETURN_OF_GOODS,
            self::SHIPMENT_TYPE_PRESENT,
        ];
    }
     ...
     * @return string[]
     */
    public function getCheckAgeServiceAllowableValues()
    {
        return [
            self::CHECK_AGE_SERVICE_NUMBER_16,
            self::CHECK_AGE_SERVICE_NUMBER_18,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('outlet_routing', $data ?? [], null);
        $this->setIfExists('bulky_goods', $data ?? [], null);
        $this->setIfExists('premium', $data ?? [], null);
        $this->setIfExists('check_age_service', $data ?? [], null);
        $this->setIfExists('endorsement', $data ?? [], null);
        $this->setIfExists('pickup_time', $data ?? [], null);
        $this->setIfExists('delivery_date', $data ?? [], null);
        $this->setIfExists('sendung_avisieren', $data ?? [], null);
        $this->setIfExists('hinweis1', $data ?? [], null);
        $this->setIfExists('hinweis2', $data ?? [], null);
        $this->setIfExists('amazon_buchungsdaten', $data ?? [], null);
        $this->setIfExists('stackable', $data ?? [], null);
        $this->setIfExists('dangerous_goods_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((mb_strlen($this->container['from_contact_name']) > 30)) {
            $invalidProperties[] = "invalid value for 'from_contact_name', the character length must be smaller than or equal to 30.";
        }
        ...
        if (!is_null($this->container['from_company_name']) && (mb_strlen($this->container['from_company_name']) > 40)) {
            $invalidProperties[] = "invalid value for 'from_company_name', the character length must be smaller than or equal to 40.";
        }
        ...
        if ((mb_strlen($this->container['from_address']) > 30)) {
            $invalidProperties[] = "invalid value for 'from_address', the character length must be smaller than or equal to 30.";
        }
        ...
        if (!is_null($this->container['from_additional_address']) && (mb_strlen($this->container['from_additional_address']) > 30)) {
            $invalidProperties[] = "invalid value for 'from_additional_address', the character length must be smaller than or equal to 30.";
        }
        ...
        if ((mb_strlen($this->container['from_city']) > 40)) {
            $invalidProperties[] = "invalid value for 'from_city', the character length must be smaller than or equal to 40.";
        }
        ...
        if ($this->container['from_phone'] === null) {
            $invalidProperties[] = "'from_phone' can't be null";
        }
        if ((mb_strlen($this->container['from_phone']) > 30)) {
            $invalidProperties[] = "invalid value for 'from_phone', the character length must be smaller than or equal to 30.";
        }

        if ((mb_strlen($this->container['from_phone']) < 1)) {
            $invalidProperties[] = "invalid value for 'from_phone', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['from_email']) && (mb_strlen($this->container['from_email']) > 75)) {
            $invalidProperties[] = "invalid value for 'from_email', the character length must be smaller than or equal to 75.";
        }
        ...
        if ((mb_strlen($this->container['to_contact_name']) > 30)) {
            $invalidProperties[] = "invalid value for 'to_contact_name', the character length must be smaller than or equal to 30.";
        }
        ...
        if (!is_null($this->container['to_company_name']) && (mb_strlen($this->container['to_company_name']) > 40)) {
            $invalidProperties[] = "invalid value for 'to_company_name', the character length must be smaller than or equal to 40.";
        }
        ...
        if ((mb_strlen($this->container['to_address']) > 30)) {
            $invalidProperties[] = "invalid value for 'to_address', the character length must be smaller than or equal to 30.";
        }
        ...
        if (!is_null($this->container['to_additional_address']) && (mb_strlen($this->container['to_additional_address']) > 30)) {
            $invalidProperties[] = "invalid value for 'to_additional_address', the character length must be smaller than or equal to 30.";
        }
        ...
        if ((mb_strlen($this->container['to_city']) > 40)) {
            $invalidProperties[] = "invalid value for 'to_city', the character length must be smaller than or equal to 40.";
        }
        ...
        if ($this->container['to_phone'] === null) {
            $invalidProperties[] = "'to_phone' can't be null";
        }
        if ((mb_strlen($this->container['to_phone']) > 30)) {
            $invalidProperties[] = "invalid value for 'to_phone', the character length must be smaller than or equal to 30.";
        }

        if ((mb_strlen($this->container['to_phone']) < 1)) {
            $invalidProperties[] = "invalid value for 'to_phone', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['to_email']) && (mb_strlen($this->container['to_email']) > 75)) {
            $invalidProperties[] = "invalid value for 'to_email', the character length must be smaller than or equal to 75.";
        }
        ...
        $allowedValues = $this->getCheckAgeServiceAllowableValues();
        if (!is_null($this->container['check_age_service']) && !in_array($this->container['check_age_service'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'check_age_service', must be one of '%s'",
                $this->container['check_age_service'],
                implode("', '", $allowedValues)
            );
        }
        ...
        if ($this->container['sendung_avisieren'] === null) {
            $invalidProperties[] = "'sendung_avisieren' can't be null";
        }
        if ((mb_strlen($this->container['sendung_avisieren']) > 30)) {
            $invalidProperties[] = "invalid value for 'sendung_avisieren', the character length must be smaller than or equal to 30.";
        }

        if ((mb_strlen($this->container['sendung_avisieren']) < 1)) {
            $invalidProperties[] = "invalid value for 'sendung_avisieren', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['hinweis1']) && (mb_strlen($this->container['hinweis1']) > 30)) {
            $invalidProperties[] = "invalid value for 'hinweis1', the character length must be smaller than or equal to 30.";
        }

        if (!is_null($this->container['hinweis1']) && (mb_strlen($this->container['hinweis1']) < 1)) {
            $invalidProperties[] = "invalid value for 'hinweis1', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['hinweis2']) && (mb_strlen($this->container['hinweis2']) > 30)) {
            $invalidProperties[] = "invalid value for 'hinweis2', the character length must be smaller than or equal to 30.";
        }

        if (!is_null($this->container['hinweis2']) && (mb_strlen($this->container['hinweis2']) < 1)) {
            $invalidProperties[] = "invalid value for 'hinweis2', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['amazon_buchungsdaten']) && (mb_strlen($this->container['amazon_buchungsdaten']) > 30)) {
            $invalidProperties[] = "invalid value for 'amazon_buchungsdaten', the character length must be smaller than or equal to 30.";
        }

        if (!is_null($this->container['amazon_buchungsdaten']) && (mb_strlen($this->container['amazon_buchungsdaten']) < 1)) {
            $invalidProperties[] = "invalid value for 'amazon_buchungsdaten', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['stackable'] === null) {
            $invalidProperties[] = "'stackable' can't be null";
        }
        if ((mb_strlen($this->container['stackable']) > 3)) {
            $invalidProperties[] = "invalid value for 'stackable', the character length must be smaller than or equal to 3.";
        }

        if ((mb_strlen($this->container['stackable']) < 2)) {
            $invalidProperties[] = "invalid value for 'stackable', the character length must be bigger than or equal to 2.";
        }

        if (!is_null($this->container['un_number']) && (mb_strlen($this->container['un_number']) > 6)) {
            $invalidProperties[] = "invalid value for 'un_number', the character length must be smaller than or equal to 6.";
        }

        if (!is_null($this->container['un_number']) && (mb_strlen($this->container['un_number']) < 6)) {
            $invalidProperties[] = "invalid value for 'un_number', the character length must be bigger than or equal to 6.";
        }
     ...
     * Gets packages
     *
     * @return \kruegge82\shipstage\Model\TNTPackage[]
     */
     ...
     * Sets packages
     *
     * @param \kruegge82\shipstage\Model\TNTPackage[] $packages packages
     *
     * @return $this
     */
    ...
    public function setFromCountry(string $from_country): static
    {
        ...
        if ((mb_strlen($from_country) > 2)) {
            throw new InvalidArgumentException('invalid length for $from_country when calling Data., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($from_country) < 2)) {
            throw new InvalidArgumentException('invalid length for $from_country when calling Data., must be bigger than or equal to 2.');
        }
    ...
    public function setFromContactName(string $from_contact_name): static
    {
        ...
        if ((mb_strlen($from_contact_name) > 30)) {
            throw new InvalidArgumentException('invalid length for $from_contact_name when calling Data., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($from_contact_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_contact_name when calling Data., must be bigger than or equal to 1.');
        }
    ...
    public function setFromCompanyName(?string $from_company_name): static
    {
        ...
        if ((mb_strlen($from_company_name) > 40)) {
            throw new InvalidArgumentException('invalid length for $from_company_name when calling Data., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($from_company_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_company_name when calling Data., must be bigger than or equal to 1.');
        }
    ...
    public function setFromAddress(string $from_address): static
    {
        ...
        if ((mb_strlen($from_address) > 30)) {
            throw new InvalidArgumentException('invalid length for $from_address when calling Data., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($from_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_address when calling Data., must be bigger than or equal to 1.');
        }
    ...
    public function setFromAdditionalAddress(?string $from_additional_address): static
    {
        ...
        if ((mb_strlen($from_additional_address) > 30)) {
            throw new InvalidArgumentException('invalid length for $from_additional_address when calling Data., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($from_additional_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_additional_address when calling Data., must be bigger than or equal to 1.');
        }
    ...
    public function setFromPostalCode(string $from_postal_code): static
    {
        ...
        if ((mb_strlen($from_postal_code) > 9)) {
            throw new InvalidArgumentException('invalid length for $from_postal_code when calling Data., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($from_postal_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_postal_code when calling Data., must be bigger than or equal to 1.');
        }
    ...
    public function setFromCity(string $from_city): static
    {
        ...
        if ((mb_strlen($from_city) > 40)) {
            throw new InvalidArgumentException('invalid length for $from_city when calling Data., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($from_city) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_city when calling Data., must be bigger than or equal to 1.');
        }
     ...
     * Sets from_phone
     *
     * @param string $from_phone from_phone
     *
     * @return $this
     */
    public function setFromPhone(string $from_phone): static
    {
        ...
        if ((mb_strlen($from_phone) > 30)) {
            throw new InvalidArgumentException('invalid length for $from_phone when calling Data., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($from_phone) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_phone when calling Data., must be bigger than or equal to 1.');
        }
    ...
    public function setFromEmail(?string $from_email): static
    {
        ...
        if ((mb_strlen($from_email) > 75)) {
            throw new InvalidArgumentException('invalid length for $from_email when calling Data., must be smaller than or equal to 75.');
        }
        if ((mb_strlen($from_email) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_email when calling Data., must be bigger than or equal to 1.');
        }
    ...
    public function setToCountry(string $to_country): static
    {
        ...
        if ((mb_strlen($to_country) > 2)) {
            throw new InvalidArgumentException('invalid length for $to_country when calling Data., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($to_country) < 2)) {
            throw new InvalidArgumentException('invalid length for $to_country when calling Data., must be bigger than or equal to 2.');
        }
    ...
    public function setToContactName(string $to_contact_name): static
    {
        ...
        if ((mb_strlen($to_contact_name) > 30)) {
            throw new InvalidArgumentException('invalid length for $to_contact_name when calling Data., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($to_contact_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_contact_name when calling Data., must be bigger than or equal to 1.');
        }
    ...
    public function setToCompanyName(?string $to_company_name): static
    {
        ...
        if ((mb_strlen($to_company_name) > 40)) {
            throw new InvalidArgumentException('invalid length for $to_company_name when calling Data., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($to_company_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_company_name when calling Data., must be bigger than or equal to 1.');
        }
    ...
    public function setToAddress(string $to_address): static
    {
        ...
        if ((mb_strlen($to_address) > 30)) {
            throw new InvalidArgumentException('invalid length for $to_address when calling Data., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($to_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_address when calling Data., must be bigger than or equal to 1.');
        }
    ...
    public function setToAdditionalAddress(?string $to_additional_address): static
    {
        ...
        if ((mb_strlen($to_additional_address) > 30)) {
            throw new InvalidArgumentException('invalid length for $to_additional_address when calling Data., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($to_additional_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_additional_address when calling Data., must be bigger than or equal to 1.');
        }
    ...
    public function setToPostalCode(string $to_postal_code): static
    {
        ...
        if ((mb_strlen($to_postal_code) > 9)) {
            throw new InvalidArgumentException('invalid length for $to_postal_code when calling Data., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($to_postal_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_postal_code when calling Data., must be bigger than or equal to 1.');
        }
    ...
    public function setToCity(string $to_city): static
    {
        ...
        if ((mb_strlen($to_city) > 40)) {
            throw new InvalidArgumentException('invalid length for $to_city when calling Data., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($to_city) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_city when calling Data., must be bigger than or equal to 1.');
        }
     ...
     * Sets to_phone
     *
     * @param string $to_phone to_phone
     *
     * @return $this
     */
    public function setToPhone(string $to_phone): static
    {
        ...
        if ((mb_strlen($to_phone) > 30)) {
            throw new InvalidArgumentException('invalid length for $to_phone when calling Data., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($to_phone) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_phone when calling Data., must be bigger than or equal to 1.');
        }
    ...
    public function setToEmail(?string $to_email): static
    {
        ...
        if ((mb_strlen($to_email) > 75)) {
            throw new InvalidArgumentException('invalid length for $to_email when calling Data., must be smaller than or equal to 75.');
        }
        if ((mb_strlen($to_email) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_email when calling Data., must be bigger than or equal to 1.');
        }
     ...
     * Sets service_code
     *
     * @param string $service_code TNT Express (tnt_express), TNT Express 9:00 (tnt_express9), TNT Express 10:00 (tnt_express10), TNT Express 12:00 (tnt_express12), TNT Economy Express (tnt_economy)
     *
     * @return $this
     */
     ...
     *
     * @param float $insurance_amount Value in EUR
     *
     * @return $this
     */
    public function setInsuranceAmount(float $insurance_amount): static
    {
        ...
        if (($insurance_amount > 50000.0)) {
            throw new InvalidArgumentException('invalid value for $insurance_amount when calling Data., must be smaller than or equal to 50000.0.');
        }
        if (($insurance_amount < 1.0)) {
            throw new InvalidArgumentException('invalid value for $insurance_amount when calling Data., must be bigger than or equal to 1.0.');
        }
     ...
     *
     * @param string $insurance_content insurance_content
     *
     * @return $this
     */
    public function setInsuranceContent(string $insurance_content): static
    {
        ...
        if ((mb_strlen($insurance_content) > 100)) {
            throw new InvalidArgumentException('invalid length for $insurance_content when calling Data., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($insurance_content) < 1)) {
            throw new InvalidArgumentException('invalid length for $insurance_content when calling Data., must be bigger than or equal to 1.');
        }
    ...
    public function setCodAmount(?float $cod_amount): static
    {
        ...
        if (($cod_amount > 2500.0)) {
            throw new InvalidArgumentException('invalid value for $cod_amount when calling Data., must be smaller than or equal to 2500.0.');
        }
        if (($cod_amount < 0.01)) {
            throw new InvalidArgumentException('invalid value for $cod_amount when calling Data., must be bigger than or equal to 0.01.');
        }
    ...
    public function setCodReason(?string $cod_reason): static
    {
        ...
        if ((mb_strlen($cod_reason) > 21)) {
            throw new InvalidArgumentException('invalid length for $cod_reason when calling Data., must be smaller than or equal to 21.');
        }
        if ((mb_strlen($cod_reason) < 1)) {
            throw new InvalidArgumentException('invalid length for $cod_reason when calling Data., must be bigger than or equal to 1.');
        }
     ...
     * Sets pickup_date
     *
     * @param string $pickup_date Pickup date must be in format DD.MM.YYYY (required for IDS, TNT and GLS Pick & Ship)
     *
     * @return $this
     */
    public function setPickupDate(string $pickup_date): static
    {
     ...
     * Sets shipment_type
     *
     * @param string|null $shipment_type Handelsware (COMMERCIAL_GOODS), Dokumente (DOCUMENT), Warenmuster (COMMERCIAL_SAMPLE), Warenrücksendung (RETURN_OF_GOODS), Geschenk (PRESENT)
     *
     * @return $this
     */
    ...
    public function setInvoiceNumber(?string $invoice_number): static
    {
        ...
        if ((mb_strlen($invoice_number) > 100)) {
            throw new InvalidArgumentException('invalid length for $invoice_number when calling Data., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($invoice_number) < 1)) {
            throw new InvalidArgumentException('invalid length for $invoice_number when calling Data., must be bigger than or equal to 1.');
        }
    ...
    public function setReference(?string $reference): static
    {
        ...
        if ((mb_strlen($reference) > 50)) {
            throw new InvalidArgumentException('invalid length for $reference when calling Data., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($reference) < 1)) {
            throw new InvalidArgumentException('invalid length for $reference when calling Data., must be bigger than or equal to 1.');
        }
     ...
     * @return bool|null
     */
    public function getOutletRouting(): ?bool
    {
        return $this->container['outlet_routing'];
    }

    /**
     * Sets outlet_routing
     *
     * @param bool|null $outlet_routing Parcel outlet routing (receiver email is required)
     *
     * @return $this
     */
    public function setOutletRouting(?bool $outlet_routing): static
    {
        if (is_null($outlet_routing)) {
            throw new InvalidArgumentException('non-nullable outlet_routing cannot be null');
        }
        $this->container['outlet_routing'] = $outlet_routing;
     ...
     * Sets bulky_goods
     *
     * @param bool|null $bulky_goods Bulky goods
     *
     * @return $this
     */
     ...
     * Sets premium
     *
     * @param bool|null $premium Premium (for DHL Warenpost only)
     *
     * @return $this
     */
    ...
    /**
     * Gets check_age_service
     *
     * @return int|null
     */
    public function getCheckAgeService(): ?int
    {
        return $this->container['check_age_service'];
    }

    /**
     * Sets check_age_service
     *
     * @param int|null $check_age_service Visual age check service
     *
     * @return $this
     */
    public function setCheckAgeService(?int $check_age_service): static
    {
        if (is_null($check_age_service)) {
            throw new InvalidArgumentException('non-nullable check_age_service cannot be null');
        }
        $allowedValues = $this->getCheckAgeServiceAllowableValues();
        if (!in_array($check_age_service, $allowedValues, true)) {
            throw new InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'check_age_service', must be one of '%s'",
                    $check_age_service,
        ...
        $this->container['check_age_service'] = $check_age_service;
     ...
     * Gets endorsement
     *
     * @return \kruegge82\shipstage\Model\Endorsement|null
     */
    public function getEndorsement(): ?\kruegge82\shipstage\Model\Endorsement
    {
     ...
     * Sets endorsement
     *
     * @param \kruegge82\shipstage\Model\Endorsement|null $endorsement endorsement
     *
     * @return $this
     */
    public function setEndorsement(?\kruegge82\shipstage\Model\Endorsement $endorsement): static
    {
     ...
     * Gets pickup_time
     *
     * @return \kruegge82\shipstage\Model\PickupTime
     */
    public function getPickupTime(): \kruegge82\shipstage\Model\PickupTime
    {
     ...
     * Sets pickup_time
     *
     * @param \kruegge82\shipstage\Model\PickupTime $pickup_time pickup_time
     *
     * @return $this
     */
    public function setPickupTime(\kruegge82\shipstage\Model\PickupTime $pickup_time): static
    {
    ...
    /**
     * Gets sendung_avisieren
     *
     * @return string
     */
    public function getSendungAvisieren(): string
    {
        return $this->container['sendung_avisieren'];
    }

    /**
     * Sets sendung_avisieren
     *
     * @param string $sendung_avisieren Phone number
     *
     * @return $this
     */
    public function setSendungAvisieren(string $sendung_avisieren): static
    {
        if (is_null($sendung_avisieren)) {
            throw new InvalidArgumentException('non-nullable sendung_avisieren cannot be null');
        }
        if ((mb_strlen($sendung_avisieren) > 30)) {
            throw new InvalidArgumentException('invalid length for $sendung_avisieren when calling Data., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($sendung_avisieren) < 1)) {
            throw new InvalidArgumentException('invalid length for $sendung_avisieren when calling Data., must be bigger than or equal to 1.');
        }

        $this->container['sendung_avisieren'] = $sendung_avisieren;
     ...
     * @return string|null
     */
    public function getHinweis1(): ?string
    {
        return $this->container['hinweis1'];
    }

    /**
     * Sets hinweis1
     *
     * @param string|null $hinweis1 hinweis1
     *
     * @return $this
     */
    public function setHinweis1(?string $hinweis1): static
    {
        if (is_null($hinweis1)) {
            throw new InvalidArgumentException('non-nullable hinweis1 cannot be null');
        }
        if ((mb_strlen($hinweis1) > 30)) {
            throw new InvalidArgumentException('invalid length for $hinweis1 when calling Data., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($hinweis1) < 1)) {
            throw new InvalidArgumentException('invalid length for $hinweis1 when calling Data., must be bigger than or equal to 1.');
        }

        $this->container['hinweis1'] = $hinweis1;
     ...
     * @return string|null
     */
    public function getHinweis2(): ?string
    {
        return $this->container['hinweis2'];
    }

    /**
     * Sets hinweis2
     *
     * @param string|null $hinweis2 hinweis2
     *
     * @return $this
     */
    public function setHinweis2(?string $hinweis2): static
    {
        if (is_null($hinweis2)) {
            throw new InvalidArgumentException('non-nullable hinweis2 cannot be null');
        }
        if ((mb_strlen($hinweis2) > 30)) {
            throw new InvalidArgumentException('invalid length for $hinweis2 when calling Data., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($hinweis2) < 1)) {
            throw new InvalidArgumentException('invalid length for $hinweis2 when calling Data., must be bigger than or equal to 1.');
        }

        $this->container['hinweis2'] = $hinweis2;

        return $this;
    }

    /**
     * Gets amazon_buchungsdaten
     *
     * @return string|null
     */
    public function getAmazonBuchungsdaten(): ?string
    {
        return $this->container['amazon_buchungsdaten'];
    }

    /**
     * Sets amazon_buchungsdaten
     *
     * @param string|null $amazon_buchungsdaten amazon_buchungsdaten
     *
     * @return $this
     */
    public function setAmazonBuchungsdaten(?string $amazon_buchungsdaten): static
    {
        if (is_null($amazon_buchungsdaten)) {
            throw new InvalidArgumentException('non-nullable amazon_buchungsdaten cannot be null');
        }
        if ((mb_strlen($amazon_buchungsdaten) > 30)) {
            throw new InvalidArgumentException('invalid length for $amazon_buchungsdaten when calling Data., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($amazon_buchungsdaten) < 1)) {
            throw new InvalidArgumentException('invalid length for $amazon_buchungsdaten when calling Data., must be bigger than or equal to 1.');
        }

        $this->container['amazon_buchungsdaten'] = $amazon_buchungsdaten;
     ...
     * Sets stackable
     *
     * @param string $stackable stackable
     *
     * @return $this
     */
    public function setStackable(string $stackable): static
    {
        ...
        if ((mb_strlen($stackable) > 3)) {
            throw new InvalidArgumentException('invalid length for $stackable when calling Data., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($stackable) < 2)) {
            throw new InvalidArgumentException('invalid length for $stackable when calling Data., must be bigger than or equal to 2.');
        }
    ...
    /**
     * Gets dangerous_goods_type
     *
     * @return \kruegge82\shipstage\Model\DangerousGoodType|null
     */
    public function getDangerousGoodsType(): ?\kruegge82\shipstage\Model\DangerousGoodType
    {
        return $this->container['dangerous_goods_type'];
    }

    /**
     * Sets dangerous_goods_type
     *
     * @param \kruegge82\shipstage\Model\DangerousGoodType|null $dangerous_goods_type dangerous_goods_type
     *
     * @return $this
     */
    public function setDangerousGoodsType(?\kruegge82\shipstage\Model\DangerousGoodType $dangerous_goods_type): static
    {
        if (is_null($dangerous_goods_type)) {
            throw new InvalidArgumentException('non-nullable dangerous_goods_type cannot be null');
        }
        $this->container['dangerous_goods_type'] = $dangerous_goods_type;
     ...
     * @return $this
     */
    public function setUnNumber(?string $un_number): static
    {
        if (is_null($un_number)) {
            throw new InvalidArgumentException('non-nullable un_number cannot be null');
        }
        if ((mb_strlen($un_number) > 6)) {
            throw new InvalidArgumentException('invalid length for $un_number when calling Data., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($un_number) < 6)) {
            throw new InvalidArgumentException('invalid length for $un_number when calling Data., must be bigger than or equal to 6.');
        }
