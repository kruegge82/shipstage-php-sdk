 ...
 */
class DHLItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DHLItem';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((mb_strlen($this->container['goods_description']) > 50)) {
            $invalidProperties[] = "invalid value for 'goods_description', the character length must be smaller than or equal to 50.";
        }
    ...
    public function setGoodsDescription(string $goods_description): static
    {
        ...
        if ((mb_strlen($goods_description) > 50)) {
            throw new InvalidArgumentException('invalid length for $goods_description when calling DHLItem., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($goods_description) < 1)) {
            throw new InvalidArgumentException('invalid length for $goods_description when calling DHLItem., must be bigger than or equal to 1.');
        }
    ...
    public function setHsCode(string $hs_code): static
    {
        ...
        if ((mb_strlen($hs_code) > 10)) {
            throw new InvalidArgumentException('invalid length for $hs_code when calling DHLItem., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($hs_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $hs_code when calling DHLItem., must be bigger than or equal to 1.');
        }
    ...
    public function setOriginCountry(string $origin_country): static
    {
        ...
        if ((mb_strlen($origin_country) > 2)) {
            throw new InvalidArgumentException('invalid length for $origin_country when calling DHLItem., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($origin_country) < 2)) {
            throw new InvalidArgumentException('invalid length for $origin_country when calling DHLItem., must be bigger than or equal to 2.');
        }
