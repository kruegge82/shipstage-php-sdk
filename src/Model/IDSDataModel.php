...
/**
 * IDSDataModel Class Doc Comment
 *
 * @package  kruegge82\shipstage
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class IDSDataModel implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'IDSDataModel';
    ...
    protected static array $openAPITypes = [
        'packages' => '\kruegge82\shipstage\Model\IDSPackage[]',
        'from_country' => 'string',
    ...
    public const SERVICE_CODE_IDS = 'ids';
    public const SERVICE_CODE__97 = '97';
    public const SERVICE_CODE__94 = '94';
    public const SERVICE_CODE__90 = '90';
    public const SERVICE_CODE__92 = '92';
    ...
    {
        return [
            self::SERVICE_CODE_IDS,
            self::SERVICE_CODE__97,
            self::SERVICE_CODE__94,
            self::SERVICE_CODE__90,
            self::SERVICE_CODE__92,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((mb_strlen($this->container['from_city']) > 35)) {
            $invalidProperties[] = "invalid value for 'from_city', the character length must be smaller than or equal to 35.";
        }
        ...
        if ((mb_strlen($this->container['from_phone']) > 20)) {
            $invalidProperties[] = "invalid value for 'from_phone', the character length must be smaller than or equal to 20.";
        }
        ...
        if (!is_null($this->container['from_email']) && (mb_strlen($this->container['from_email']) > 35)) {
            $invalidProperties[] = "invalid value for 'from_email', the character length must be smaller than or equal to 35.";
        }
        ...
        if ((mb_strlen($this->container['to_city']) > 35)) {
            $invalidProperties[] = "invalid value for 'to_city', the character length must be smaller than or equal to 35.";
        }
        ...
        if ((mb_strlen($this->container['to_phone']) > 20)) {
            $invalidProperties[] = "invalid value for 'to_phone', the character length must be smaller than or equal to 20.";
        }
        ...
        if (!is_null($this->container['to_email']) && (mb_strlen($this->container['to_email']) > 35)) {
            $invalidProperties[] = "invalid value for 'to_email', the character length must be smaller than or equal to 35.";
        }
        ...
        if (!is_null($this->container['sendung_avisieren']) && (mb_strlen($this->container['sendung_avisieren']) > 30)) {
            $invalidProperties[] = "invalid value for 'sendung_avisieren', the character length must be smaller than or equal to 30.";
        }

        if (!is_null($this->container['sendung_avisieren']) && (mb_strlen($this->container['sendung_avisieren']) < 1)) {
     ...
     * Gets packages
     *
     * @return \kruegge82\shipstage\Model\IDSPackage[]
     */
     ...
     * Sets packages
     *
     * @param \kruegge82\shipstage\Model\IDSPackage[] $packages packages
     *
     * @return $this
     */
    ...
    public function setFromCountry(string $from_country): static
    {
        ...
        if ((mb_strlen($from_country) > 2)) {
            throw new InvalidArgumentException('invalid length for $from_country when calling IDSDataModel., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($from_country) < 2)) {
            throw new InvalidArgumentException('invalid length for $from_country when calling IDSDataModel., must be bigger than or equal to 2.');
        }
    ...
    public function setFromContactName(string $from_contact_name): static
    {
        ...
        if ((mb_strlen($from_contact_name) > 35)) {
            throw new InvalidArgumentException('invalid length for $from_contact_name when calling IDSDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($from_contact_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_contact_name when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromCompanyName(?string $from_company_name): static
    {
        ...
        if ((mb_strlen($from_company_name) > 35)) {
            throw new InvalidArgumentException('invalid length for $from_company_name when calling IDSDataModel., must be smaller than or equal to 35.');
        }
    ...
    public function setFromAddress(string $from_address): static
    {
        ...
        if ((mb_strlen($from_address) > 35)) {
            throw new InvalidArgumentException('invalid length for $from_address when calling IDSDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($from_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_address when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromAdditionalAddress(?string $from_additional_address): static
    {
        ...
        if ((mb_strlen($from_additional_address) > 35)) {
            throw new InvalidArgumentException('invalid length for $from_additional_address when calling IDSDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($from_additional_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_additional_address when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromPostalCode(string $from_postal_code): static
    {
        ...
        if ((mb_strlen($from_postal_code) > 9)) {
            throw new InvalidArgumentException('invalid length for $from_postal_code when calling IDSDataModel., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($from_postal_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_postal_code when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromCity(string $from_city): static
    {
        ...
        if ((mb_strlen($from_city) > 35)) {
            throw new InvalidArgumentException('invalid length for $from_city when calling IDSDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($from_city) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_city when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromPhone(string $from_phone): static
    {
        ...
        if ((mb_strlen($from_phone) > 20)) {
            throw new InvalidArgumentException('invalid length for $from_phone when calling IDSDataModel., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($from_phone) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_phone when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromEmail(?string $from_email): static
    {
        ...
        if ((mb_strlen($from_email) > 35)) {
            throw new InvalidArgumentException('invalid length for $from_email when calling IDSDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($from_email) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_email when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToCountry(string $to_country): static
    {
        ...
        if ((mb_strlen($to_country) > 2)) {
            throw new InvalidArgumentException('invalid length for $to_country when calling IDSDataModel., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($to_country) < 2)) {
            throw new InvalidArgumentException('invalid length for $to_country when calling IDSDataModel., must be bigger than or equal to 2.');
        }
    ...
    public function setToContactName(string $to_contact_name): static
    {
        ...
        if ((mb_strlen($to_contact_name) > 35)) {
            throw new InvalidArgumentException('invalid length for $to_contact_name when calling IDSDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($to_contact_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_contact_name when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToCompanyName(?string $to_company_name): static
    {
        ...
        if ((mb_strlen($to_company_name) > 35)) {
            throw new InvalidArgumentException('invalid length for $to_company_name when calling IDSDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($to_company_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_company_name when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToAddress(string $to_address): static
    {
        ...
        if ((mb_strlen($to_address) > 35)) {
            throw new InvalidArgumentException('invalid length for $to_address when calling IDSDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($to_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_address when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToAdditionalAddress(?string $to_additional_address): static
    {
        ...
        if ((mb_strlen($to_additional_address) > 35)) {
            throw new InvalidArgumentException('invalid length for $to_additional_address when calling IDSDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($to_additional_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_additional_address when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToPostalCode(string $to_postal_code): static
    {
        ...
        if ((mb_strlen($to_postal_code) > 9)) {
            throw new InvalidArgumentException('invalid length for $to_postal_code when calling IDSDataModel., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($to_postal_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_postal_code when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToCity(string $to_city): static
    {
        ...
        if ((mb_strlen($to_city) > 35)) {
            throw new InvalidArgumentException('invalid length for $to_city when calling IDSDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($to_city) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_city when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToPhone(string $to_phone): static
    {
        ...
        if ((mb_strlen($to_phone) > 20)) {
            throw new InvalidArgumentException('invalid length for $to_phone when calling IDSDataModel., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($to_phone) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_phone when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToEmail(?string $to_email): static
    {
        ...
        if ((mb_strlen($to_email) > 35)) {
            throw new InvalidArgumentException('invalid length for $to_email when calling IDSDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($to_email) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_email when calling IDSDataModel., must be bigger than or equal to 1.');
        }
     ...
     * Sets service_code
     *
     * @param string $service_code IDS Standard (ids), IDS FIX (97), IDS Express 8:00 (94), IDS Express 10:00 (90), IDS Express 12:00 (92)
     *
     * @return $this
     */
    ...
    public function setInsuranceAmount(float $insurance_amount): static
    {
        ...
        if (($insurance_amount > 50000.0)) {
            throw new InvalidArgumentException('invalid value for $insurance_amount when calling IDSDataModel., must be smaller than or equal to 50000.0.');
        }
        if (($insurance_amount < 1.0)) {
            throw new InvalidArgumentException('invalid value for $insurance_amount when calling IDSDataModel., must be bigger than or equal to 1.0.');
        }
    ...
    public function setInsuranceContent(string $insurance_content): static
    {
        ...
        if ((mb_strlen($insurance_content) > 100)) {
            throw new InvalidArgumentException('invalid length for $insurance_content when calling IDSDataModel., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($insurance_content) < 1)) {
            throw new InvalidArgumentException('invalid length for $insurance_content when calling IDSDataModel., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $sendung_avisieren Phone number
     *
     * @return $this
     */
    public function setSendungAvisieren(?string $sendung_avisieren): static
    {
        ...
        if ((mb_strlen($sendung_avisieren) > 30)) {
            throw new InvalidArgumentException('invalid length for $sendung_avisieren when calling IDSDataModel., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($sendung_avisieren) < 1)) {
            throw new InvalidArgumentException('invalid length for $sendung_avisieren when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setHinweis1(?string $hinweis1): static
    {
        ...
        if ((mb_strlen($hinweis1) > 30)) {
            throw new InvalidArgumentException('invalid length for $hinweis1 when calling IDSDataModel., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($hinweis1) < 1)) {
            throw new InvalidArgumentException('invalid length for $hinweis1 when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setHinweis2(?string $hinweis2): static
    {
        ...
        if ((mb_strlen($hinweis2) > 30)) {
            throw new InvalidArgumentException('invalid length for $hinweis2 when calling IDSDataModel., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($hinweis2) < 1)) {
            throw new InvalidArgumentException('invalid length for $hinweis2 when calling IDSDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setAmazonBuchungsdaten(?string $amazon_buchungsdaten): static
    {
        ...
        if ((mb_strlen($amazon_buchungsdaten) > 30)) {
            throw new InvalidArgumentException('invalid length for $amazon_buchungsdaten when calling IDSDataModel., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($amazon_buchungsdaten) < 1)) {
            throw new InvalidArgumentException('invalid length for $amazon_buchungsdaten when calling IDSDataModel., must be bigger than or equal to 1.');
        }
