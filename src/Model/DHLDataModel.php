...
/**
 * DHLDataModel Class Doc Comment
 *
 * @package  kruegge82\shipstage
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DHLDataModel implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DHLDataModel';
    ...
    protected static array $openAPITypes = [
        'packages' => '\kruegge82\shipstage\Model\DHLPackage[]',
        'from_country' => 'string',
    ...
    public const SERVICE_CODE_DHL_PAKET = 'dhl_paket';
    public const SERVICE_CODE_DHL_WARENPOST = 'dhl_warenpost';
    public const SERVICE_CODE_DHL_KLEINPAKET = 'dhl_kleinpaket';
    ...
    {
        return [
            self::SERVICE_CODE_DHL_PAKET,
            self::SERVICE_CODE_DHL_WARENPOST,
            self::SERVICE_CODE_DHL_KLEINPAKET,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((mb_strlen($this->container['from_address']) > 50)) {
            $invalidProperties[] = "invalid value for 'from_address', the character length must be smaller than or equal to 50.";
        }
        ...
        if (!is_null($this->container['from_postal_code']) && (mb_strlen($this->container['from_postal_code']) > 17)) {
            $invalidProperties[] = "invalid value for 'from_postal_code', the character length must be smaller than or equal to 17.";
        }

        if (!is_null($this->container['from_postal_code']) && (mb_strlen($this->container['from_postal_code']) < 1)) {
        ...
        if ((mb_strlen($this->container['from_city']) > 50)) {
            $invalidProperties[] = "invalid value for 'from_city', the character length must be smaller than or equal to 50.";
        }
        ...
        if (!is_null($this->container['from_phone']) && (mb_strlen($this->container['from_phone']) > 35)) {
            $invalidProperties[] = "invalid value for 'from_phone', the character length must be smaller than or equal to 35.";
        }
        ...
        if (!is_null($this->container['from_email']) && (mb_strlen($this->container['from_email']) > 70)) {
            $invalidProperties[] = "invalid value for 'from_email', the character length must be smaller than or equal to 70.";
        }
        ...
        if ((mb_strlen($this->container['to_address']) > 50)) {
            $invalidProperties[] = "invalid value for 'to_address', the character length must be smaller than or equal to 50.";
        }
        ...
        if (!is_null($this->container['to_postal_code']) && (mb_strlen($this->container['to_postal_code']) > 17)) {
            $invalidProperties[] = "invalid value for 'to_postal_code', the character length must be smaller than or equal to 17.";
        }

        if (!is_null($this->container['to_postal_code']) && (mb_strlen($this->container['to_postal_code']) < 1)) {
        ...
        if ((mb_strlen($this->container['to_city']) > 50)) {
            $invalidProperties[] = "invalid value for 'to_city', the character length must be smaller than or equal to 50.";
        }
        ...
        if (!is_null($this->container['to_phone']) && (mb_strlen($this->container['to_phone']) > 35)) {
            $invalidProperties[] = "invalid value for 'to_phone', the character length must be smaller than or equal to 35.";
        }
        ...
        if (!is_null($this->container['to_email']) && (mb_strlen($this->container['to_email']) > 70)) {
            $invalidProperties[] = "invalid value for 'to_email', the character length must be smaller than or equal to 70.";
        }
     ...
     * Gets packages
     *
     * @return \kruegge82\shipstage\Model\DHLPackage[]
     */
     ...
     * Sets packages
     *
     * @param \kruegge82\shipstage\Model\DHLPackage[] $packages packages
     *
     * @return $this
     */
    ...
    public function setFromCountry(string $from_country): static
    {
        ...
        if ((mb_strlen($from_country) > 2)) {
            throw new InvalidArgumentException('invalid length for $from_country when calling DHLDataModel., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($from_country) < 2)) {
            throw new InvalidArgumentException('invalid length for $from_country when calling DHLDataModel., must be bigger than or equal to 2.');
        }
    ...
    public function setFromContactName(string $from_contact_name): static
    {
        ...
        if ((mb_strlen($from_contact_name) > 35)) {
            throw new InvalidArgumentException('invalid length for $from_contact_name when calling DHLDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($from_contact_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_contact_name when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromCompanyName(?string $from_company_name): static
    {
        ...
        if ((mb_strlen($from_company_name) > 35)) {
            throw new InvalidArgumentException('invalid length for $from_company_name when calling DHLDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($from_company_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_company_name when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromAddress(string $from_address): static
    {
        ...
        if ((mb_strlen($from_address) > 50)) {
            throw new InvalidArgumentException('invalid length for $from_address when calling DHLDataModel., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($from_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_address when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromAdditionalAddress(?string $from_additional_address): static
    {
        ...
        if ((mb_strlen($from_additional_address) > 35)) {
            throw new InvalidArgumentException('invalid length for $from_additional_address when calling DHLDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($from_additional_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_additional_address when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromPostalCode(?string $from_postal_code): static
    {
        ...
        if ((mb_strlen($from_postal_code) > 17)) {
            throw new InvalidArgumentException('invalid length for $from_postal_code when calling DHLDataModel., must be smaller than or equal to 17.');
        }
        if ((mb_strlen($from_postal_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_postal_code when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromCity(string $from_city): static
    {
        ...
        if ((mb_strlen($from_city) > 50)) {
            throw new InvalidArgumentException('invalid length for $from_city when calling DHLDataModel., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($from_city) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_city when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromPhone(?string $from_phone): static
    {
        ...
        if ((mb_strlen($from_phone) > 35)) {
            throw new InvalidArgumentException('invalid length for $from_phone when calling DHLDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($from_phone) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_phone when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFromEmail(?string $from_email): static
    {
        ...
        if ((mb_strlen($from_email) > 70)) {
            throw new InvalidArgumentException('invalid length for $from_email when calling DHLDataModel., must be smaller than or equal to 70.');
        }
        if ((mb_strlen($from_email) < 1)) {
            throw new InvalidArgumentException('invalid length for $from_email when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToCountry(string $to_country): static
    {
        ...
        if ((mb_strlen($to_country) > 2)) {
            throw new InvalidArgumentException('invalid length for $to_country when calling DHLDataModel., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($to_country) < 2)) {
            throw new InvalidArgumentException('invalid length for $to_country when calling DHLDataModel., must be bigger than or equal to 2.');
        }
    ...
    public function setToContactName(string $to_contact_name): static
    {
        ...
        if ((mb_strlen($to_contact_name) > 35)) {
            throw new InvalidArgumentException('invalid length for $to_contact_name when calling DHLDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($to_contact_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_contact_name when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToCompanyName(?string $to_company_name): static
    {
        ...
        if ((mb_strlen($to_company_name) > 35)) {
            throw new InvalidArgumentException('invalid length for $to_company_name when calling DHLDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($to_company_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_company_name when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToAddress(string $to_address): static
    {
        ...
        if ((mb_strlen($to_address) > 50)) {
            throw new InvalidArgumentException('invalid length for $to_address when calling DHLDataModel., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($to_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_address when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToAdditionalAddress(?string $to_additional_address): static
    {
        ...
        if ((mb_strlen($to_additional_address) > 35)) {
            throw new InvalidArgumentException('invalid length for $to_additional_address when calling DHLDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($to_additional_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_additional_address when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToPostalCode(?string $to_postal_code): static
    {
        ...
        if ((mb_strlen($to_postal_code) > 17)) {
            throw new InvalidArgumentException('invalid length for $to_postal_code when calling DHLDataModel., must be smaller than or equal to 17.');
        }
        if ((mb_strlen($to_postal_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_postal_code when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToCity(string $to_city): static
    {
        ...
        if ((mb_strlen($to_city) > 50)) {
            throw new InvalidArgumentException('invalid length for $to_city when calling DHLDataModel., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($to_city) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_city when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToPhone(?string $to_phone): static
    {
        ...
        if ((mb_strlen($to_phone) > 35)) {
            throw new InvalidArgumentException('invalid length for $to_phone when calling DHLDataModel., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($to_phone) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_phone when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setToEmail(?string $to_email): static
    {
        ...
        if ((mb_strlen($to_email) > 70)) {
            throw new InvalidArgumentException('invalid length for $to_email when calling DHLDataModel., must be smaller than or equal to 70.');
        }
        if ((mb_strlen($to_email) < 1)) {
            throw new InvalidArgumentException('invalid length for $to_email when calling DHLDataModel., must be bigger than or equal to 1.');
        }
     ...
     * Sets service_code
     *
     * @param string $service_code DHL Paket (dhl_paket), DHL Warenpost (dhl_warenpost), DHL Kleinpaket (dhl_kleinpaket)
     *
     * @return $this
     */
    ...
    public function setInvoiceNumber(?string $invoice_number): static
    {
        ...
        if ((mb_strlen($invoice_number) > 100)) {
            throw new InvalidArgumentException('invalid length for $invoice_number when calling DHLDataModel., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($invoice_number) < 1)) {
            throw new InvalidArgumentException('invalid length for $invoice_number when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setInsuranceAmount(?float $insurance_amount): static
    {
        ...
        if (($insurance_amount > 50000.0)) {
            throw new InvalidArgumentException('invalid value for $insurance_amount when calling DHLDataModel., must be smaller than or equal to 50000.0.');
        }
        if (($insurance_amount < 1.0)) {
            throw new InvalidArgumentException('invalid value for $insurance_amount when calling DHLDataModel., must be bigger than or equal to 1.0.');
        }
    ...
    public function setInsuranceContent(?string $insurance_content): static
    {
        ...
        if ((mb_strlen($insurance_content) > 100)) {
            throw new InvalidArgumentException('invalid length for $insurance_content when calling DHLDataModel., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($insurance_content) < 1)) {
            throw new InvalidArgumentException('invalid length for $insurance_content when calling DHLDataModel., must be bigger than or equal to 1.');
        }
    ...
    public function setCodAmount(?float $cod_amount): static
    {
        ...
        if (($cod_amount > 2500.0)) {
            throw new InvalidArgumentException('invalid value for $cod_amount when calling DHLDataModel., must be smaller than or equal to 2500.0.');
        }
        if (($cod_amount < 0.01)) {
            throw new InvalidArgumentException('invalid value for $cod_amount when calling DHLDataModel., must be bigger than or equal to 0.01.');
        }
    ...
    public function setCodReason(?string $cod_reason): static
    {
        ...
        if ((mb_strlen($cod_reason) > 21)) {
            throw new InvalidArgumentException('invalid length for $cod_reason when calling DHLDataModel., must be smaller than or equal to 21.');
        }
        if ((mb_strlen($cod_reason) < 1)) {
            throw new InvalidArgumentException('invalid length for $cod_reason when calling DHLDataModel., must be bigger than or equal to 1.');
        }
